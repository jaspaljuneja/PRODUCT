...
In this phase, we basically see how our product is performing in the market. Are user’s liking it, we collect feedback from the user. And then if need to tweak the product it goes again in the next sprint or next release. 
